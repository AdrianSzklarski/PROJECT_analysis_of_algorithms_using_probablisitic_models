...
class Prom:
    ...
    def get_radius_change(self):
        C1, C2 = self.get_deformations()
...
if __name__ == '__main__':
    ...
    hear.get_stresses(), hear.get_deformations(), hear.get_radius_change()
    print(hear)
    print(hear.get_radius_change())
